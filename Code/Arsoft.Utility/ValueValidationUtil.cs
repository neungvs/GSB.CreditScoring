...
namespace Arsoft.Utility
{
    public class ValueValidationUtil
    {
        public static string GetString(object data)
        {
            ...
            {
                LogFiles.WriteToLog("CheckValue", "GetString()", ex.Message);
        ...
        public static int GetInt(object data)
        {
            ...
            {
                LogFiles.WriteToLog("CheckValue", "GetInt()", ex.Message);
                throw new Exception(ex.Message, ex.InnerException);
            }
            return result;
        }
        ...
        public static short GetShort(object data)
        {
            ...
            {
                LogFiles.WriteToLog("CheckValue", "GetShort()", ex.Message);
                throw new Exception(ex.Message, ex.InnerException);
            }
            return result;
        }
        ...
        public static decimal GetDecimal(object data)
        {
            ...
            {
                LogFiles.WriteToLog("CheckValue", "GetDecimal()", ex.Message);
                throw new Exception(ex.Message, ex.InnerException);
            }
            return result;
        }
        ...
        public static decimal GetLong(object data)
        {
            ...
            {
                LogFiles.WriteToLog("CheckValue", "GetLong()", ex.Message);
                throw new Exception(ex.Message, ex.InnerException);
            }
            return result;
        }
        ...
        public static DateTime GetDateTime(object data)
        {
            ...
            {
                LogFiles.WriteToLog("CheckValue", "GetDateTime()", ex.Message);
                throw new Exception(ex.Message, ex.InnerException);
            }
            return result;
        }
        ...
        public static bool GetBoolean(object data)
        {
            ...
            {
                LogFiles.WriteToLog("CheckValue", "GetBool()", ex.Message);
                throw new Exception(ex.Message, ex.InnerException);
            }
            return result;
        }

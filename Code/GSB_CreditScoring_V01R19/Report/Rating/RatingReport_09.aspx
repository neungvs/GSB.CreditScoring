<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CreditScoring.Master" AutoEventWireup="true" CodeBehind="RatingReport_09.aspx.cs" Inherits="GSB.Report.Rating.RatingReport_09" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        ...
        <ContentTemplate>
            <asp:Table ID="Table1" runat="server" CellPadding="0" CellSpacing="0" CssClass="Search">
                <asp:TableHeaderRow>
                    <asp:TableHeaderCell ColumnSpan="2"><u>เครื่องมือค้นหา</u> : รายงานทดสอบความแม่นยำของคำตอบ </asp:TableHeaderCell>
                </asp:TableHeaderRow>
                <asp:TableRow>
                    ...
                    <asp:TableCell CssClass="TableRow">
                        <asp:Table ID="HeadTxtLoan" runat="server" CellPadding="0" CellSpacing="0" CssClass="ExpandTable">
                            <asp:TableRow ID="TableRow1" runat="server">
                                ...
                                <asp:TableCell Width="50px">คะแนนคำถามข้อที่ 1 ก่อนถ่วงน้ำหนัก</asp:TableCell>
                                <asp:TableCell Width="50px">คะแนนคำถามข้อที่ 1 หลังถ่วงน้ำหนัก</asp:TableCell>
                                <asp:TableCell Width="50px">คะแนนคำถามข้อที่ 2 ก่อนถ่วงน้ำหนัก</asp:TableCell>
                                <asp:TableCell Width="50px">คะแนนคำถามข้อที่ 2 หลังถ่วงน้ำหนัก</asp:TableCell>
                                <asp:TableCell Width="50px">คะแนนคำถามข้อที่ 3 ก่อนถ่วงน้ำหนัก</asp:TableCell>
                                <asp:TableCell Width="50px">คะแนนคำถามข้อที่ 3 หลังถ่วงน้ำหนัก</asp:TableCell>
                                <asp:TableCell Width="50px">คะแนนคำถามข้อที่ 4 ก่อนถ่วงน้ำหนัก</asp:TableCell>
                                <asp:TableCell Width="50px">คะแนนคำถามข้อที่ 4 หลังถ่วงน้ำหนัก</asp:TableCell>
                                <asp:TableCell Width="50px">คะแนนคำถามข้อที่ 5 ก่อนถ่วงน้ำหนัก</asp:TableCell>
                                <asp:TableCell Width="50px">คะแนนคำถามข้อที่ 5 หลังถ่วงน้ำหนัก</asp:TableCell>
                            </asp:TableRow>
                        ...
                        <asp:BoundField DataField="IND1_BWS" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="IND1_PTS" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="IND2_BWS" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="IND2_PTS" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="IND3_BWS" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="IND3_PTS" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="IND4_BWS" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="IND4_PTS" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="IND5_BWS" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="IND5_PTS" ItemStyle-Width="50px" />
                        </Columns>
                        </asp:GridView> 
                        </asp:TableCell>
                        </asp:TableRow>    

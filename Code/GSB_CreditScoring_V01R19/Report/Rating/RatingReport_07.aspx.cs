...
{
    public partial class RatingReport_07 : System.Web.UI.Page
    {
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        string appQuery1 = string.Format("EXEC [RPT_7_Test_Quantity_Quality_Variable] '{0}','{1}','{2}'", ddlModel.SelectedItem.Value, ddlLoan.SelectedItem.Value, ddlStatDate.SelectedItem.Value);

...
{
    public partial class RatingReport_14 : System.Web.UI.Page
    {
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string appQuery1 = string.Format("EXEC [RPT_4_3_1_Oligor_By_End_of_Month] '{0}','{1}'", ddlModel.SelectedItem.Value, ddlStatDate.SelectedItem.Value);
                    gvTable.DataSource = conn.ExcuteSQL(appQuery1);
                    gvTable.DataBind();
                    string appQuery2 = string.Format("EXEC [RPT_4_3_2_FSClass_By_End_of_Month] '{0}','{1}'", ddlModel.SelectedItem.Value, ddlStatDate.SelectedItem.Value);
                    GridView1.DataSource = conn.ExcuteSQL(appQuery2);
                    GridView1.DataBind();
                    string appQuery3 = string.Format("EXEC [RPT_4_4_1_Oligor_By_End_of_Month_Proportion] '{0}','{1}'", ddlModel.SelectedItem.Value, ddlStatDate.SelectedItem.Value);
                    GridView4.DataSource = conn.ExcuteSQL(appQuery3);
                    GridView4.DataBind();
                    string appQuery4 = string.Format("EXEC RPT_4_4_2_FSClass_By_End_of_Month_Proportion '{0}','{1}'", ddlModel.SelectedItem.Value, ddlStatDate.SelectedItem.Value);

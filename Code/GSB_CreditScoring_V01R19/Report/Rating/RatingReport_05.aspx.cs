...
{
    public partial class RatingReport_05 : System.Web.UI.Page
    {
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string appQuery1 = string.Format("EXEC RPT_5_PD_Value '{0}','{1}'", ddlModel.SelectedItem.Value, ddlLoan.SelectedItem.Value);

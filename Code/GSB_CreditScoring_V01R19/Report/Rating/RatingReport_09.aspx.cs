...
{
    public partial class RatingReport_09 : System.Web.UI.Page
    {
        ...
        {
            string Query = string.Format("select dd_List as STYPER_NAME from Report_Dropdown_List where dd_Group ='QUESTION_TYPE'");
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            string appQuery1 = string.Format("EXEC [RPT_9_Test_Answer] '{0}','{1}','{2}','{3}'", ddlSubType.SelectedItem.Value, ddlModel.SelectedItem.Value, ddlLoan.SelectedItem.Value, ddlStatDate.SelectedItem.Value);

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CreditScoring.Master" AutoEventWireup="true" CodeBehind="RatingReport_07.aspx.cs" Inherits="GSB.Report.Rating.RatingReport_07" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        ...
        <ContentTemplate>
            <asp:Table ID="Table1" runat="server" CellPadding="0" CellSpacing="0" CssClass="Search">
                <asp:TableHeaderRow>
                    <asp:TableHeaderCell ColumnSpan="2"><u>เครื่องมือค้นหา</u> : รายงานทดสอบความแม่นยำตัวแปรเชิงคุณภาพและปริมาณ </asp:TableHeaderCell>
                </asp:TableHeaderRow>
                <asp:TableRow>
                    ...
                    <asp:TableCell CssClass="TableRow">
                        <asp:Table ID="HeadTxtLoan" runat="server" CellPadding="0" CellSpacing="0" CssClass="ExpandTable">
                            <asp:TableRow ID="TableRow1" runat="server">
                                ...
                                <asp:TableCell Width="50px">รวมคะแนนคำถามเชิงคุณภาพก่อนถ่วงน้ำหนัก</asp:TableCell>
                                <asp:TableCell Width="50px">รวมคะแนนคำถามเชิงคุณภาพหลังถ่วงน้ำหนัก</asp:TableCell>
                                <asp:TableCell Width="50px">รวมคะแนนคำถามเชิงปริมาณก่อนถ่วงน้ำหนัก</asp:TableCell>
                                <asp:TableCell Width="50px">รวมคะแนนคำถามเชิงปริมาณหลังถ่วงน้ำหนัก</asp:TableCell>
                            </asp:TableRow>
                        ...
                        <asp:BoundField DataField="QTY_BWS" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="QTY_PTS" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="FIN_BWS" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="FIN_PTS" ItemStyle-Width="50px" />
                        </Columns>
                        </asp:GridView> 
                        </asp:TableCell>
                        </asp:TableRow>    

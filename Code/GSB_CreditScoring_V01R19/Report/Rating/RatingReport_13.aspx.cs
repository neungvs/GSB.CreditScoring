...
{
    public partial class RatingReport_13 : System.Web.UI.Page
    {
        ...
        private void LoadQT()
        {
            string Query = string.Format("select dd_List as QT_NAME from Report_Dropdown_List where dd_Group ='QUESTION_TYPE'");

            ddlqtion.DataSource = conn.ExcuteSQL(Query);
            ddlqtion.DataBind();
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            string appQuery1 = string.Format("EXEC RPT_13_Distribution_NPLs '{0}','{1}','{2}','{3}'", ddlModel.SelectedItem.Value, ddlLoan.SelectedItem.Value, ddlqtion.SelectedItem.Value, ddlStatDate.SelectedItem.Value);

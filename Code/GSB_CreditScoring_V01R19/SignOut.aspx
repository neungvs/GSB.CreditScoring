<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Login.Master" AutoEventWireup="true" CodeBehind="SignOut.aspx.cs" Inherits="GSB.SignOut" %>
...
<asp:Label ID="message" runat="server" CssClass="login_error" Width="581" Height="100" Text="ออกจากระบบเรียบร้อย"/>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CreditScoring.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="GSB.LoanSystem.Profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            &nbsp;</td>
                        <td>
                            <asp:TextBox ID="txtUserID" runat="server"  Width="50px" MaxLength="15" 
                        ...
                        <td>
                            <asp:TextBox ID="txtUserName" runat="server" CssClass="txt" Width="100" 
                                MaxLength="150"  Enabled="false" ReadOnly="True"></asp:TextBox></td>
                        <td>
                     ...
                     <td>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlGroup" runat="server" CssClass="ddl" 
                                DataTextField="Group_name" DataValueField="Group_id" Width="100px" 
                                Enabled="False">
                            </asp:DropDownList></td>
                        <td>
                            <asp:CheckBox ID="cbLock" runat="server" CssClass="cbsearch" Width="80px" 
                                Enabled="False"/></td>
                    </tr>
                    <tr>
                        <td colspan="1">
                        ...
                        <td colspan="10">
                        <asp:Button ID="btnAdd" runat="server" CssClass="btnsearch" OnClick="btnAdd_Click" 
                                Text="ADD" Width="50px" TabIndex="0" Visible="False"/>&nbsp;&nbsp;&nbsp;
    ...
    <asp:Label ID="lblstr" runat="server" ForeColor="Red" Width="400px"></asp:Label>&nbsp;
     <asp:GridView ID="gvUser" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        PagerSettings-PageButtonCount="10" PagerStyle-HorizontalAlign="Center" 

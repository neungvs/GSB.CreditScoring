<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoadCBS.aspx.cs" Inherits="GSB.LoanSystem.LoadCBS" %>
...
<body>
    ...
    <center>
        ...
        <asp:Label ID="Label1" runat="server" Text="Run Batch to Import LOPs Data"></asp:Label>
         <br />
        <br />
        <br />

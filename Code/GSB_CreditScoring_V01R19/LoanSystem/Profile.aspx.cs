    ...
    public partial class Profile : System.Web.UI.Page
    {
            ...
            else if (e.CommandName.Equals("Select"))
            {
                ...
                if (ds.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        btnUpdate.Enabled = true;
                        txtUserpwd.Enabled = true;
                        txtUserpName.Enabled = false;
                        txtUserName.Enabled = false;
                        txtUserSurName.Enabled = false;
                        txtUserDesc.Enabled = false;
                        lblstr.Text = "กำลังแก้ไขรายการ (Edit Mode)";
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sqlStatementdgrp = "update s_user set USER_PWD = '" + txtUserpwd.Text.Trim() + "', GROUP_ID = '" + ddlGroup.SelectedValue + "',USER_PNAME = '" +
                 txtUserpName.Text.Trim() + "',USER_FNAME = '" + txtUserName.Text.Trim() + "',USER_SNAME = '" + txtUserSurName.Text.Trim() + "',USER_DESC = '" +
                 txtUserDesc.Text.Trim() + "',ACTIVE_FLAG = '" + cbLock.Checked + "' where USER_ID = '" + txtUserID.Text.Trim() + "'";
                ...
                if (chk)
                {
                    try
                    {
                        ...
                        string sqlStatementdgrp = "insert into s_user (USER_ID,USER_PWD,GROUP_ID,USER_PNAME,USER_FNAME,USER_SNAME,USER_DESC,ACTIVE_FLAG) values('" +
                            txtUserID.Text.Trim() + "','" + txtUserpwd.Text.Trim() + "','" + ddlGroup.SelectedValue + "','" + txtUserpName.Text.Trim() + "','" + txtUserName.Text.Trim() + "','" +
                            txtUserSurName.Text.Trim() + "','" + txtUserDesc.Text.Trim() + "','" + cbLock.Checked + "')";
